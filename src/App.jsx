  ...
  return (
    ...
    ">
      <div className='h-[70%] w-[80%] relative flex flex-col items-center justify-center'>
        ...
        <div className='h-[70%]'>
          <h1 className=' font-bold text-5xl leading-tight p-4 rounded-lg bg-gradient-to-r from-[#75ff35b4] to-[#d554f5] text-transparent bg-clip-text transition-transform transform hover:scale-100'>
            MERN Alert System
          </h1>
